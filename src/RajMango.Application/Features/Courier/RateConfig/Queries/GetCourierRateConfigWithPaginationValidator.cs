...
{
    public class GetCourierRateConfigWithPaginationValidator
        : AbstractValidator<GetCourierRateConfigWithPaginationQuery>
    {
        public GetCourierRateConfigWithPaginationValidator()
        {
